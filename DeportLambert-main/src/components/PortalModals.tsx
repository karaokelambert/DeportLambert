...
export function InstallAppModal({ isOpen, onClose }: ModalProps) {
  const [installStatus, setInstallStatus] = useState<'idle' | 'success' | 'manual'>('idle');
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/85 backdrop-blur-md animate-fade-in" onClick={onClose}>
      <div 
        className="w-full max-w-lg bg-slate-900 border-2 border-amber-500/60 rounded-3xl p-6 sm:p-8 shadow-[0_0_60px_rgba(245,158,11,0.3)] text-slate-100 relative overflow-hidden"
      ...
      >
        ...
        <div className="flex items-center gap-3.5 mb-5">
          <div className="w-14 h-14 rounded-2xl bg-gradient-to-br from-amber-500 via-orange-600 to-amber-700 p-0.5 shadow-lg shadow-orange-900/50 flex items-center justify-center shrink-0">
            <img 
              src="/pwa-192x192.png" 
          ...
          <div>
            ...
            <p className="text-xs text-amber-400 font-medium">PWA Oficial Multi-Plataforma (PC, Android e iOS)</p>
          </div>
        </div>

        {installStatus === 'success' ? (
          <div className="p-6 rounded-2xl bg-emerald-950/60 border border-emerald-500/60 text-center space-y-2 my-4">
            <div className="text-3xl">🎉</div>
            <p className="text-base font-black text-emerald-400 uppercase">¡Instalación Iniciada con Éxito!</p>
            <p className="text-xs text-slate-300">JL Sports Club 360 ahora está en tu dispositivo.</p>
          </div>
        ) : (
          <div className="space-y-4 my-6">
            <div className="flex items-start gap-4 p-4 rounded-2xl bg-slate-800/70 border border-slate-700/70">
              ...
              <div>
                ...
                <p className="text-xs text-slate-300 mt-1 leading-relaxed">
                  📱 <strong>Android:</strong> Pulsa el botón "Instalar en este dispositivo" o toca el menú (⋮) y elige <strong className="text-amber-400">"Instalar aplicación"</strong>.<br />
                  🍏 <strong>iPhone / iOS:</strong> Toca el botón <strong>Compartir (⎋)</strong> de Safari y pulsa <strong className="text-amber-400">"Añadir a la pantalla de inicio (+)"</strong>.
                </p>
              </div>
            </div>
            ...
            <div className="flex items-start gap-4 p-4 rounded-2xl bg-slate-800/70 border border-slate-700/70">
              ...
              <div>
                ...
                <p className="text-xs text-slate-300 mt-1 leading-relaxed">
                  💻 Haz clic en el botón de abajo o en el <strong>icono de instalar</strong> (pantalla con flecha) a la derecha de la barra de direcciones.
                </p>
              </div>
            </div>
          </div>
        ...
        <div className="flex flex-col sm:flex-row gap-3 pt-2">
          <button
            ...
            className="flex-1 py-3.5 px-6 rounded-2xl font-black uppercase text-xs tracking-wider bg-gradient-to-r from-amber-500 via-orange-500 to-amber-600 hover:from-amber-400 hover:to-orange-500 text-slate-950 shadow-lg shadow-orange-600/40 hover:scale-[1.02] active:scale-95 transition-all flex items-center justify-center gap-2 cursor-pointer"
          >
            <Download className="w-4 h-4 stroke-[2.5]" /> Instalar en este dispositivo
          </button>
          <button
            onClick={onClose}
